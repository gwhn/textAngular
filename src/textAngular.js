            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    scope.showPopover = function (_el) {
                        ...
                        oneEvent(element, 'click keyup', function () {
                            scope.hidePopover();
                        });
                    };
                    ...
                    var applyImageSafeCSS = function (element, properties) {
                        ...
                        if ($element[0].tagName.toLowerCase() === 'img') {
                            if (properties.height) {
                                $element.css('height', properties.height).removeAttr('height');
                            }
                            if (properties.width) {
                                $element.css('width', properties.width).removeAttr('width');
                            }
                    ...
                    scope.showResizeOverlay = function (_el) {
                        ...
                        scope.reflowResizeOverlay(_el);
                        oneEvent(element, 'click', function () {
